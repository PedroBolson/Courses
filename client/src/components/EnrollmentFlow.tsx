...
import { CreditCard, User, Lock, CheckCircle, ArrowRight, ArrowLeft, DollarSign } from 'lucide-react';
...
export default function EnrollmentFlow({
    ...
    const processEnrollment = async () => {
        try {
            ...
            addQuery(fixedAlunoData.executedQuery, 'POST /alunos');
                            ...
                            <>
                                ...
                                >                                    <span>
                                        {currentStep === 'personal' ? 'Continuar' :
                                            currentStep === 'payment' ? 'Finalizar Matrícula' : 'Fechar'}
                                    </span>
